...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Ohho Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Ohho Core"
...
#define PACKAGE_BUGREPORT "https://github.com/ohho-project/ohho/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Ohho Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Ohho Core 0.18.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ohho"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://ohho.org/"
