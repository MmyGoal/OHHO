...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ohho-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ohho-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ohho transaction") + "\n" +
              "  ohho-tx [options] -create [commands]   " + _("Create hex-encoded ohho transaction") + "\n" +
              "\n";
