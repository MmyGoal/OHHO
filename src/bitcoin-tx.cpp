...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ohho-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ohho-tx [options] <hex-tx> [commands]  Update hex-encoded ohho transaction\n" +
            "or:     ohho-tx [options] -create [commands]   Create hex-encoded ohho transaction\n" +
            "\n";
