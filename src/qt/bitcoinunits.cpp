...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("OHO");
    case mBTC: return QString("Ohkanda");
    case uBTC: return QString("qOhkanda");
    case SAT: return QString("liOhkanda");
