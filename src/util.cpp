...
const char * const BITCOIN_CONF_FILENAME = "ohho.conf";
const char * const BITCOIN_PID_FILENAME = "ohho.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Ohho";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Ohho";
#else
    // Unix
    return pathRet / ".ohho";
#endif
