...
"""Verify that starting ohho with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ohho with -h for help text")
        ...
        self.log.info("Start ohho with -version for version information")
        ...
        self.log.info("Start ohhod with -fakearg to make sure it does not start")
