...
ohho.conf        | contains configuration settings for ohhod or ohho-qt
ohhod.pid        | stores the process id of ohhod while running
...
debug.log           | contains debug information and general logging generated by ohhod or ohho-qt
