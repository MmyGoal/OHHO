# Support for Output Descriptors in Ohho Core

Since Ohho Core v0.17, there is support for Output Descriptors. This is a
...
on Ohho's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Ohho Core wallets, a convenience function `combo` is
