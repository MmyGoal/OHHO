Ohho Core version *0.15.1* is now available from:

  <https://download.ohho.org/ohho-0.15.1/>
...
A number of changes to the way Ohho Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 Ohkanda per kB (0.00001 OHO). This is to prepare for dropping the minimum transaction fee to 0.1 Ohkanda per kB (0.0001 OHO) in the next release.
