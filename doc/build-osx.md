...
1. Clone the Ohho Core source code:
...
2.  Build Ohho Core:
    ...
    Configure and build the headless Ohho Core binaries as well as the GUI (if Qt is found).
...
5.  Installation into user directories (optional):
    ...
    or
        ...
        cd ~/ohho/src
        cp ohhod /usr/local/bin/
        cp ohho-cli /usr/local/bin/
...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/Ohho"

    touch "/Users/${USER}/Library/Application Support/Ohho/ohho.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Ohho/ohho.conf"

The first time you run ohhod, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
