...
ACLOCAL = ${SHELL} /root/ohho-master/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /root/ohho-master/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/ohho-master/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/ohho-master/build-aux/missing automake-1.15
...
BITCOIN_WALLET_TOOL_NAME = ohho-wallet
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /root/ohho-master/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_STRING = Ohho Core 0.18.1
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /root/ohho-master
abs_srcdir = /root/ohho-master
abs_top_builddir = /root/ohho-master
abs_top_srcdir = /root/ohho-master
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/ohho-master/build-aux/install-sh
...
$(OSX_APP)/Contents/MacOS/Ohho-Qt: all-recursive
	$(MKDIR_P) $(@D)
